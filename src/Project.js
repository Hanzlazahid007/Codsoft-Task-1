...
const Project = () => {
  ...
  return (
    <>
      {data.map((item, index) => {
        return (
          <div className="max-w-md  p-4 rounded border-[1px] border-[#3F6EEC4F] overflow-hidden shadow-lg bg-white">
            <img src="#" alt="News" />
            <div className="px-6 py-4 -ml-6">
              <button className="bg-[#256CFC1F] text-[#3F6EEC] rounded-lg px-4 py-2  mb-2">
                News
              </button>
              <h1 className="font-medium  text-[22px] text-[#05264E] mb-2">
